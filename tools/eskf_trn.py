...
terr_t = spl(lat_t, lon_t, grid=False)                       # world == database
...
plt.tight_layout(); plt.savefig(HERE.parent/'data'/'flight001_eksf.png', dpi=150)
print("Saved data/flight001_eksf.png")
